...
public class Event extends DomainObject {
    ...
    public void setAirDates(LinkedHashSet<LocalDateTime> airDates) {
        NavigableSet<LocalDateTime> result = new TreeSet<LocalDateTime>();
        for(LocalDateTime value : airDates){
            result.add(value);
        }
        this.airDates =  result;
    }
    ...
    public void setAuditoriums(LinkedHashMap<LocalDateTime, Auditorium> auditoriums) {
        NavigableMap<LocalDateTime, Auditorium> result = new TreeMap<LocalDateTime,Auditorium>();
        for(Map.Entry<LocalDateTime,Auditorium> auditoriumsEntry : auditoriums.entrySet()){
            result.put(auditoriumsEntry.getKey(),auditoriumsEntry.getValue());
        }
        this.auditoriums = result;

        //set airDates
        Set<LocalDateTime> airDates = auditoriums.keySet();
        NavigableSet<LocalDateTime> airDatesNavigable = new TreeSet<>();

        for(LocalDateTime airDate: airDates){
            airDatesNavigable.add(airDate);
        }
        this.airDates = airDatesNavigable;
    }
